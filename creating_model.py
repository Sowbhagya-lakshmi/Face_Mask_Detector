...
path = '/content/drive/MyDrive/mask_detection/mask_no_mask_dataset.npy'
...
# Training the model
file_path = '/content/drive/MyDrive/mask_detection/mask_no_mask_model.hdf5'
check_point = ModelCheckpoint(file_path, monitor = 'val_loss', verbose = 1, save_best_only = True, mode = 'min')
callbacks_list = [check_point]
model.fit(normalised_train_inputs, train_targets, validation_split = 0.05, batch_size=200, epochs = 30, callbacks = callbacks_list, verbose = 1)
